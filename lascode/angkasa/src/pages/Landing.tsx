...
export default function Landing() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Contact Section */}
      <section id="contact" className="relative z-10 py-20 px-6 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Hubungi Kami
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="glass p-8 rounded-xl border border-secondary/20 bg-slate-800/30 backdrop-blur-sm">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">Jl. Pendidikan No. 123, Jakarta Selatan, Indonesia</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">info@angkasa.id</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center shrink-0">
            ...
            {/* Contact Form */}
            <motion.div
              className="glass p-8 rounded-xl border border-secondary/20 bg-slate-800/30 backdrop-blur-sm"
            ...
            >
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-primary/25"
                >
                  Kirim Pesan
                </button>
              </form>
