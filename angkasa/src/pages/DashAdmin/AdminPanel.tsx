...
const AdminPanel: React.FC<{ userId: string; onNavigate?: (route: 'posts' | 'notifications') => void }> = ({ userId, onNavigate }) => (
  <div className="space-y-6 md:space-y-8">
    {/* Welcome Card */}
    <div className="bg-slate-800 border border-slate-700 p-6 md:p-8 rounded-xl shadow-2xl text-center">
      <h1 className="text-2xl md:text-4xl font-extrabold text-white mb-1 md:mb-2">Selamat Datang, Sobat!</h1>
    ...
    <div className="bg-gray-900 border border-slate-700 p-5 md:p-6 rounded-xl shadow-xl">
      <h2 className="text-lg md:text-2xl font-bold text-white border-b border-gray-700 pb-2 mb-3">Informasi Akun</h2>
      <p className="text-gray-400 text-sm md:text-base">Anda masuk sebagai Admin.</p>
      ...
      <p className="text-xs md:text-sm text-gray-500 italic mt-2">ID ini penting untuk identifikasi data publik dan private.</p>
    </div>
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
      ...
      >
        ...
        <p className="text-gray-400 text-sm md:text-base flex-grow">Tambahkan, edit, atau hapus Postingan Lomba untuk peserta.</p>
      </button>
      ...
      >
        ...
        <p className="text-gray-400 text-sm md:text-base flex-grow">Kirim pesan penting kepada semua peserta lomba.</p>
      </button>
    </div>
  </div>
);
