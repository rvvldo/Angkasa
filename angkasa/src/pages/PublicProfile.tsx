    ...
    <div className="relative min-h-screen bg-slate-950 text-slate-200 pb-20 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="relative h-48 md:h-64 bg-gradient-to-r from-blue-900 via-purple-900 to-slate-900 overflow-hidden">
          <button
            onClick={() => navigate(-1)}
            className="absolute top-4 left-4 z-20 p-2 bg-slate-900/50 backdrop-blur-md rounded-full text-white hover:bg-slate-800 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 -mt-24 px-4 items-start max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-18 shadow-2xl relative overflow-hidden">
              <div className="relative flex flex-col items-center mb-4 p-6">
                ...
                <div className="flex items-center gap-2 text-slate-400 mt-1">
                  ...
                  <span className="text-sm">• {city_region}</span>
                </div>
              </div>

              <div className="px-6 pb-6 space-y-4 pt-0 border-t border-slate-700/50">
                <div className="flex justify-between items-center py-2 mt-4">
                  <span className="text-slate-400 text-sm">Experience</span>
                  <span className="text-white font-medium text-sm">{experience_level}</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-white font-medium text-sm">Member</span>
                </div>
              ...
              {currentUser && currentUser.id !== user.id && (
                <div className="px-6 pb-6 mt-2">
                  {loadingFriend ? (
                    <button disabled className="w-full py-2 bg-slate-700/50 text-white rounded-xl cursor-not-allowed text-sm font-medium">
                      Loading...
                    </button>
                  ) : isFriend ? (
                    <button disabled className="w-full py-2 bg-green-600/20 text-green-400 border border-green-500/30 rounded-xl cursor-default text-sm font-medium flex items-center justify-center gap-2">
                      <CheckCircle className="w-4 h-4" /> Berteman
                    </button>
                  ) : (
                    <button
                      onClick={addFriend}
                      className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl transition-all shadow-lg shadow-blue-900/20 text-sm font-medium"
                    >
                      + Tambah Teman
                    </button>
                  )}
            ...
            <div className="hidden lg:block bg-slate-800/40 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-6 shadow-xl">
          ...
          <div className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-300">
                      {name}
                    </div>
                  </div>
                  <div>
                    <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5 block">Bio Singkat</label>
                    <div className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-300 min-h-[80px]">
                      {bio || "Tidak ada bio."}
                    </div>
                  </div>
                </div>
                  ...
                  {social_media.instagram && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-white">{social_media.instagram}</p>
                      </div>
                    </motion.a>
                  )}
                  {social_media.youtube && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-white">{social_media.youtube}</p>
                      </div>
                    </motion.a>
                  )}
                  {social_media.tiktok && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-white">{social_media.tiktok}</p>
                      </div>
                    </motion.a>
                  )}
                </div>
            ...
            <div className="block lg:hidden bg-slate-800/40 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-6 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-bold text-white flex items-center gap-2">
                  <Crown className="w-5 h-5 text-amber-500" /> Pencapaian
                </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {certificates.length === 0 ? (
                  <div className="col-span-full py-12 text-center border-2 border-dashed border-slate-700/50 rounded-2xl">
                    ...
                    <p className="text-slate-600 text-sm">User belum memiliki sertifikat publik</p>
                  </div>
                ) : (
