...
export default function Profile() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-200 selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 md:px-6 pt-20 sm:pt-24 md:pt-32 pb-12 max-w-7xl mb-20 sm:mb-0">
        {/* Banner/Header */}
        <div className="relative rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden h-32 sm:h-40 md:h-48 lg:h-64 mb-10 sm:mb-12 md:mb-16 bg-gradient-to-r from-blue-900 via-blue-900 to-slate-900">
          {bannerPhoto ? (
            <img
              src={bannerPhoto}
              alt="Banner"
          ...
          <div className="absolute bottom-2 sm:bottom-3 md:bottom-4 right-2 sm:right-3 md:right-4 flex gap-1.5 sm:gap-2">
            <input
              type="file"
              id="banner-upload"
              accept="image/*"
            ...
            <label
              ...
              className="p-1.5 sm:p-2 bg-black/30 hover:bg-black/50 backdrop-blur-sm rounded-lg text-white transition-colors cursor-pointer"
              title="Ubah Banner"
            >
            ...
            {bannerPhoto && (
              <button
                ...
                className="p-1.5 sm:p-2 bg-red-600/80 hover:bg-red-600 backdrop-blur-sm rounded-lg text-white transition-colors"
                title="Hapus Banner"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8 -mt-16 sm:-mt-20 md:-mt-24 px-1 sm:px-2 md:px-4">
          {/* Left Sidebar (Profile Card) */}
          <div className="lg:col-span-4 space-y-3 sm:space-y-4 md:space-y-6">
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl border border-slate-700/50 p-4 sm:p-6 md:p-8 shadow-2xl relative overflow-hidden">
              <div className="relative flex flex-col items-center mb-3 sm:mb-4">
                <div className="relative">
                  ...
                  <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-slate-800 p-1 border-4 border-slate-800 shadow-xl overflow-hidden">
                    {profilePhoto ? (
                      ...
                      <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold text-white">
                  ...
                  <label
                    ...
                    className="absolute bottom-0 sm:bottom-1 right-0 sm:right-1 p-1 sm:p-1.5 md:p-2 bg-blue-600 hover:bg-blue-500 rounded-full text-white shadow-lg border-2 border-slate-800 transition-colors cursor-pointer"
                  ...
                  {profilePhoto && (
                    <button
                      ...
                      className="absolute bottom-0 sm:bottom-1 left-0 sm:left-1 p-1 sm:p-1.5 md:p-2 bg-red-600 hover:bg-red-500 rounded-full text-white shadow-lg border-2 border-slate-800 transition-colors"
                ...
                <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-slate-400 mt-1">
                  ...
                  <span className="text-[10px] sm:text-xs md:text-sm">• {city}</span>
                </div>
              </div>

              <div className="space-y-3 sm:space-y-4 pt-3 sm:pt-4 border-t border-slate-700/50">
                <div className="flex justify-between items-center py-1.5 sm:py-2">
                  <span className="text-slate-400 text-xs sm:text-sm">Experience</span>
                  <span className="text-white font-medium text-xs sm:text-sm">{experience}</span>
                </div>
                <div className="flex justify-between items-center py-1.5 sm:py-2">
                  <span className="text-slate-400 text-xs sm:text-sm">Bergabung</span>
                  <span className="text-white font-medium text-xs sm:text-sm">Des 2025</span>
                </div>
            ...
            {/* Achievements Widget */}
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl border border-slate-700/50 p-3 sm:p-4 md:p-6 shadow-xl">
            ...
            {/* Menu Widget */}
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl border border-slate-700/50 p-2 sm:p-3 md:p-4 shadow-xl divide-y divide-slate-700/50">
              <button className="w-full flex items-center justify-between p-2 sm:p-3 text-slate-300 hover:text-white hover:bg-slate-700/30 rounded-lg sm:rounded-xl transition-colors">
                <span className="flex items-center gap-2 sm:gap-3 font-medium text-xs sm:text-sm"><Settings className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Pengaturan</span>
                <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-500" />
              </button>
              <button
                onClick={() => setShowHelpModal(true)}
                className="w-full flex items-center justify-between p-2 sm:p-3 text-slate-300 hover:text-white hover:bg-slate-700/30 rounded-lg sm:rounded-xl transition-colors"
              >
                <span className="flex items-center gap-2 sm:gap-3 font-medium text-xs sm:text-sm"><HelpCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Bantuan & Laporan</span>
                <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-500" />
              </button>
              <button
                onClick={handleLogout}
                className="w-full flex items-center justify-between p-2 sm:p-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg sm:rounded-xl transition-colors"
              >
                <span className="flex items-center gap-2 sm:gap-3 font-medium text-xs sm:text-sm"><LogOut className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Keluar</span>
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl border border-slate-700/50 p-4 sm:p-6 md:p-8 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <input value={name} onChange={(e) => setName(e.target.value)} className="w-full bg-slate-900/50 border border-slate-700 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 transition-colors" />
                  </div>
                  <div>
                    ...
                    <textarea value={bio} onChange={(e) => setBio(e.target.value)} rows={3} className="w-full bg-slate-900/50 border border-slate-700 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 transition-colors resize-none" />
                  </div>
                </div>
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <input value={institution} onChange={(e) => setInstitution(e.target.value)} placeholder="Contoh: SMA Negeri 1 Jakarta" className="w-full bg-slate-900/50 border border-slate-700 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 transition-colors" />
                  </div>
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      ...
                      <input value={city} onChange={(e) => setCity(e.target.value)} className="w-full bg-slate-900/50 border border-slate-700 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 transition-colors" />
                    </div>
                    <div>
                      ...
                      <select value={experience} onChange={(e) => setExperience(e.target.value)} className="w-full bg-slate-900/50 border border-slate-700 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 transition-colors appearance-none">
              ...
              <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-slate-700/50 flex justify-end">
                <button onClick={handleSave} disabled={isSaving} className="px-4 sm:px-6 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg sm:rounded-xl font-medium text-xs sm:text-sm transition-all shadow-lg shadow-blue-900/20 disabled:opacity-50 flex items-center gap-1.5 sm:gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                  {instagram && (
                    <motion.a
                      ...
                      className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-br from-pink-500/10 to-blue-500/10 rounded-lg sm:rounded-xl border border-pink-500/20 hover:border-pink-500/40 transition-colors"
                    >
                      <div className="p-1.5 sm:p-2 bg-gradient-to-br from-pink-500 to-blue-600 rounded-lg">
                        <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[10px] sm:text-xs text-slate-400">Instagram</p>
                        <p className="text-xs sm:text-sm font-medium text-white truncate">{instagram}</p>
                      </div>
                    </motion.a>
                  )}
                  {youtube && (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                {certificates.length === 0 ? (
                  <div className="col-span-full py-8 sm:py-10 md:py-12 text-center border-2 border-dashed border-slate-700/50 rounded-xl sm:rounded-2xl">
                    ...
                    <p className="text-slate-600 text-xs sm:text-sm">Sertifikat dari email terverifikasi akan muncul di sini</p>
                  </div>
                ) : (
